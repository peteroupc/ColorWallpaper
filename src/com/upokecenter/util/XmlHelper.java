...
public final class XmlHelper
{
	...
	public static boolean IsName(XmlPullParser reader, String namespaceName, String localName){
		...
		if(isNullOrEmpty(ns))ns=null;
		if(isNullOrEmpty(namespaceName))namespaceName=null;
	...
	public static boolean moveToElement(XmlPullParser parser, String namespaceName, String name)
			throws XmlPullParserException, IOException {
		while(Read(parser)){
//			DebugUtility.log("%s %s %s",IsStartElement(parser),parser.getName(),IsStartElement(parser,namespaceName,name));
