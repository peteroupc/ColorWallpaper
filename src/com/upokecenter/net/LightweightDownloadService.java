...
public final class LightweightDownloadService {
	private LightweightCacheService service;
	...
	public void sendRequest(final String url, final IProcessResponseListener<Object> cbobj,
	...
	private void handleDownload(final String url, final IProcessResponseListener<Object> cbobj,
			final IOnFinishedListener<Object> finobj) {
		service.enableCache();
		try {
